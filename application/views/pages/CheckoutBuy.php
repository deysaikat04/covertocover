            			...
            			<div id="accordion" class="checkout_accordion mt--30" role="tablist">
									 <div class="payment">
											<div class="che__header" role="tab" id="headingOne">
													<a class="accordion-toggle checkout__title" data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
															<span>Order Summary & Billing</span>
													</a>
											</div>
											<div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">

												<div class="row collapse_billing">
										...
										<?php if ($bookCart) {
											?>
											 ...
											 <ul class="order_product">
												<li><?php echo $bookCart['bookname'];?>   × <?php echo $bookCart['qnty'];?><span>₹ <?php echo $bookCart['totalprice'];?></span></li>                    
												</ul>
											 <?php 
										} ?>				
									...
									<div class="checkout__actions">
										...
										<button class="tocart" type="submit" onclick="getQuantity()" >Continue with PayPal</button>
									</div>
             		</form>
