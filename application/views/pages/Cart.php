                                ...
                                <tbody>
                                	<?php if ($bookCart) {
                   									 ...
                   									 foreach ($bookCart as $row) { 
																			...
																			<tr>
																				<td class="product-thumbnail"><a href="#"><img src="<?php echo $admin.$row['path'];?>" alt="product img"></a></td>
																				<td class="product-name" style="width:50%;">
																					<p class="book-name"><?php echo $row['bookname'];?> </p>
																					<p class="author-name"><strong>Author:</strong> <?php echo $row['authorname'];?> </p>
																					<p class="author-name"><strong>Price:</strong> ₹ <?php echo $row['price'];?></p>
																				...
																				<td class="product-quantity" style=""><input class="cart-input" id="<?php echo $count;?>" min="1" type="number" value="1" name="input-1"></td>
																				
																				<td class="product-price"><span class="amount">₹ <span class="total" id="total-<?php echo $count;?>"><?php echo $row['price'];?></span></span></td>
                        ...
                        <div class="cartbox__total__area">
                            <div class="cartbox-total d-flex justify-content-between">
                                <ul class="cart__total__list">
                                    <li>Subtotal (<p id="item-number"><?php echo count($baseprice); ?> item<?php if(count($baseprice)>1) echo 's'; ?></p> ) </li>
                                </ul>
                                <ul class="cart__total__tk">
                                    <li>₹ <p id="grand-total"> <?php echo array_sum($baseprice); ?></p></li>
                                </ul>
                            </div>
                            
                            <div class="checkout__actions">
                           		<form id="myform" method="post" action="<?php echo base_url()?>View/Checkout">
