...
$config['smtp_host']        = 'cs-mum-2.webhostbox.net';           // smtp.gmail.com smtp-relay.gmail.com
$config['smtp_user']        = 'received@jiauto.jp';
$config['smtp_pass']        = 'E{6_;pn=W+2a';         // Lenov0GM@!L123
$config['smtp_port']        = 465;                      // 587 465 25
